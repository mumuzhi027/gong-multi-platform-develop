...
class ClassroomBoard(BaseModel):
    ...
    def to_category(self):
        ...
        for classroom in self.classrooms:
            if classroom.name.startswith("信息科技大楼"):
                ret.classrooms.setdefault("信科楼", []).append(classroom)
                classroom.name = classroom.name.removeprefix("信息科技大楼")
                classroom.name = classroom.name.replace("阶梯", "阶")
                continue
